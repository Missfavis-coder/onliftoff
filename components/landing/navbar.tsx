      ...
      <div className="container-width flex items-center justify-between py-4">
          ...
          {navigationLinks.map(({ name, link }) => {
            ...
            return (
              ...
              >
                ...
                {/* ACTIVE LINE */}
                <span
                  className={`absolute -bottom-2 left-0 h-[2px] rounded-full bg-white transition-all duration-300 ${
                    isActive ? "w-full" : "w-0"
                  }`}
                />
              </Link>
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <button
            ...
            className="primary-button text-[15px]"
          >
            Request access 
          </button>
        </div>
        ...
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <Button
            ...
            variant="outline"
            className="rounded-[10px] p-4 bg-transparent border   hover:bg-white/5 hover:text-[#181229] text-sm"
          >
Hire with Liftoff
          </Button>
      ...
      {/* MOBILE MENU */}
      <div
        className={`fixed left-0 right-0 bottom-0 top-[0px]  z-40 bg-[#fffbf4] transition-all duration-500 lg:hidden ${
          isMenuOpen
